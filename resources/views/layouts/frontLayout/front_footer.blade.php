    <footer id="footer">
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    <p class="pull-left">Copyright © 2019 E-SHOPPER Inc. All rights are not reserved.</p>
                    <p class="pull-right">Developped by <span><a target="_blank" href="http://www.themeum.com">Hamza</a></span></p>
                </div>
            </div>
        </div>
