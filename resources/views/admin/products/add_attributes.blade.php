                            ...
                            <table class="table table-bordered data-table center">
                                ...
                                <tbody>
                                    ...
                                    <tr class="gradeX center">
                                        ...
                                        <td style="text-align:center"><input type="text" name="price[]" value="{{ $attribute->price }}"></td>
                                        <td style="text-align:center"><input type="text" name="stock[]" value="{{ $attribute->stock }}"></td>
