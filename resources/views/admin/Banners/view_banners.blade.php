                                ...
                                @foreach($banners as $banner)
                                    <tr class="gradeX center">
                                        ...
                                        <td style="text-align:center">
                                            ...
                                            <img src="{{ asset('images/frontend_images/banners/'.$banner->image) }}" style="width:80px">
                                            @endif
                                        </td>
                                        <td style="text-align:center" class="center">
                                            <a href="{{ url('/admin/edit-banner/'.$banner->id) }}" class="btn btn-primary btn-mini" title="Edit banner">Edit</a>
                                            <a id="delBanner" rel="{{ $banner->id }}" rel1="delete-banner" <?php //href="{{ url('/admin/delete-banner/'.$banner->id) }}"// ?> href="javascript:" class="btn btn-danger btn-mini deleteRecord" title="Delete banner">Delete</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
